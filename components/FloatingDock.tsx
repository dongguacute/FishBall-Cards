    ...
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50">
      ...
      <div className="relative group">
        ...
        <div className="relative flex items-center gap-1 px-2 py-1.5 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border border-zinc-200 dark:border-zinc-800 rounded-full shadow-sm overflow-hidden">
          ...
          {/* 学生列表选项 */}
          <button className={`relative flex items-center gap-2 px-3 py-1.5 rounded-full transition-colors duration-200 group/item ${
            activeTab === 'students'
          ...
          <button
            ...
            className={`relative flex items-center gap-2 px-3 py-1.5 rounded-full transition-colors duration-200 group/item ${
              activeTab === 'add'
                ? 'bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900'
                : 'hover:bg-zinc-100 dark:hover:bg-zinc-800'
            }`}
